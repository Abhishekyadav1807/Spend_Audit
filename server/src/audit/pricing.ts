...
export const TOOL_PLAN_PRICING_USD: Record<ToolId, PlanPriceMap> = {
  ...
  claude: { free: 0, pro: 20, max: 100, team: 30, enterprise: 60, api: 30 },
  chatgpt: { free: 0, plus: 20, team: 30, enterprise: 60, api: 30 },
  anthropic_api: { api: 30 },
  openai_api: { api: 30 },
  gemini: { pro: 20, ultra: 250, api: 25 },
  windsurf: { free: 0, pro: 15, team: 30, enterprise: 55 },
};
